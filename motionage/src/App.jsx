...
import BlogPost from './components/BlogPost'; // ADDED: Blog post detail component
        ...
        <div className="relative min-h-screen font-sans antialiased selection:bg-blue-500/30 selection:text-blue-600 dark:selection:text-blue-200 bg-slate-50 dark:bg-[#050814]">
          ...
          <main className="pt-24 flex-grow">
            <Routes>
              ...
              {/* Blog Routes - ADDED detailed post route */}
              <Route path="/blog" element={<BlogPage />} /> 
              <Route path="/blog/:id" element={<BlogPost />} /> {/* ADDED: Individual blog post route */}
