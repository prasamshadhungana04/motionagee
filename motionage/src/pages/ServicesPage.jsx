  ...
  return (
    <div className="w-full relative overflow-hidden bg-slate-50 dark:bg-[#050814] font-sans transition-colors duration-500 selection:bg-blue-500/30">
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 border-b border-slate-200 dark:border-white/5 overflow-hidden">
        ...
        {/* Background Image - Using Unsplash's high-quality tech/IT related image */}
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop"
            alt="Digital technology background with network connections"
            className="w-full h-full object-cover"
          />
          {/* Dark/Light Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-white/90 via-white/80 to-white/90 dark:from-slate-900/95 dark:via-slate-900/90 dark:to-slate-900/95 backdrop-blur-[1px]"></div>
        </div>
